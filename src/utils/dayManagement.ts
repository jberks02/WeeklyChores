export const defaultChoreList: choreApp.choreSet = {
    Sunday: [{ chore: 'dishes', status: false }, { status: false, chore: 'trash' }, { chore: 'bathrooms', status: false }],
    Monday: [{ status: false, chore: 'laundry' }, { chore: 'dishes', status: false }],
